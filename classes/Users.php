...
class Users extends Dbh {
    ...
    public function add_user_db($first_name, $last_name, $department, $gender, $telephone, $password){
        ...
        $query = "INSERT INTO users (FirstName, LastName, Department, Gender, Telephone, Password) VALUES(?,?,?,?,?,?)";
        $stmt = $conn->prepare($query);
        
        return ($stmt -> execute([$first_name, $last_name, $department, $gender, $telephone, $password]));
    }
